...
#define MAIN_LOG_BUF_LEN	(512*HISI_1K)
#define EVENTS_LOG_BUF_LEN	(512*HISI_1K)
#define RADIO_LOG_BUF_LEN	(512*HISI_1K)
#define SYSTEM_LOG_BUF_LEN	(512*HISI_1K)
#define EXCEPTION_LOG_BUF_LEN	(16*HISI_1K)
#define POWER_LOG_BUF_LEN	(512*HISI_1K)
...
#define K3_EXCEPTION_LOG_BASE	(K3_SYSTEM_LOG_BASE+SYSTEM_LOG_BUF_LEN)
#define K3_POWER_LOG_BASE	(K3_EXCEPTION_LOG_BASE+EXCEPTION_LOG_BUF_LEN)
