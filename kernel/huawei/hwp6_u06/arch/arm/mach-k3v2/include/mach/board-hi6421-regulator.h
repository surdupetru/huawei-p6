...
static struct regulator_consumer_supply ldo5_consumers[] = {
    ...
    REGULATOR_SUPPLY("sdhub-vddio-vddios", NULL),
    REGULATOR_SUPPLY("felica-hvdd-u9700l-vcc", NULL),
};
...
static struct regulator_consumer_supply ldo7_consumers[] = {
    ...
    REGULATOR_SUPPLY("sdhub-vddsd", NULL),
};
...
static struct regulator_consumer_supply ldo10_consumers[] = {
    ...
    REGULATOR_SUPPLY("felica-tvdd-u9700l-vcc", NULL),    
};
...
static struct regulator_consumer_supply ldo12_consumers[] = {
    ...
    REGULATOR_SUPPLY("sdhub-avdd", NULL),
	REGULATOR_SUPPLY("vdd-vib-ldo12", "hkvibrator"),
};
...
#endif
#ifdef CONFIG_P2_TP_TK_CMD_FEATURE          /*V4 board*/
	REGULATOR_SUPPLY("so340010_V13", "k3_dev_lcd"),
#endif
	REGULATOR_SUPPLY("ts-vdd-cypress", "2-001a"),//cypress
	REGULATOR_SUPPLY("vdd-vib-ldo13", "hkvibrator"),
};
static struct regulator_consumer_supply ldo14_consumers[] = {
	//REGULATOR_SUPPLY("wifiio-vcc", NULL),
	//REGULATOR_SUPPLY("bt-io-vcc", "bt-io"),
