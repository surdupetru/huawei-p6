...
config_pair  hw_apu1ve_k3oem_configs [] = {
    ...
    {"audio/audience_addr", (unsigned int)3, E_CONFIG_DATA_TYPE_INT },
    ...
    {"product/name", (const unsigned int)(unsigned int*)"apu1ve_k3oem", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_apu1ve_k3oem= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_APU1VE_K3OEM,
	.data_array={.config_pair_ptr=hw_apu1ve_k3oem_configs},
	.list={NULL,NULL},
};
