...
config_pair  hw_vdcs_k3oem_configs [] = {
    ...
    {"product/name", (const unsigned int)(unsigned int*)"vdcs_k3oem", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_vdcs_k3oem= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_VDCS_K3OEM,
	.data_array={.config_pair_ptr=hw_vdcs_k3oem_configs},
	.list={NULL,NULL},
};
