...
#define V4L2_CID_GET_HDR_LUX_MATRIX (V4L2_CID_PRIVACY + 87)

#define V4L2_CID_GET_HDR_CTRL_POINTS (V4L2_CID_PRIVACY + 88)

#define V4L2_CID_GET_HDR_INFO		(V4L2_CID_PRIVACY + 89)
/* < zhoutian 00195335 12-7-16 added for auto scene detect begin */
#define V4L2_CID_SET_AE_COFF            (V4L2_CID_PRIVACY + 90)
#define V4L2_CID_GET_AE_COFF            (V4L2_CID_PRIVACY + 91)
#define V4L2_CID_GET_EXTRA_COFF         (V4L2_CID_PRIVACY + 92)
#define V4L2_CID_GET_AWB_COFF           (V4L2_CID_PRIVACY + 93)
#define V4L2_CID_SET_AWB_COFF           (V4L2_CID_PRIVACY + 94)
#define V4L2_CID_GET_AWB_CT_COFF        (V4L2_CID_PRIVACY + 95)
#define V4L2_CID_SET_AWB_CT_COFF        (V4L2_CID_PRIVACY + 96)
#define V4L2_CID_GET_CCM_COFF           (V4L2_CID_PRIVACY + 97)
#define V4L2_CID_SET_CCM_COFF           (V4L2_CID_PRIVACY + 98)
#define V4L2_CID_SET_FOCUS_RANGE        (V4L2_CID_PRIVACY + 99)
#define V4L2_CID_SET_FPS_RANGE          (V4L2_CID_PRIVACY + 100)
#define V4L2_CID_SET_MAX_EXPOSURE       (V4L2_CID_PRIVACY + 101)
#define V4L2_CID_SET_ADDED_COFF         (V4L2_CID_PRIVACY + 102)

#define V4L2_CID_GET_COFF_SEQ           (V4L2_CID_PRIVACY + 105)
#define V4L2_CID_SET_COFF_SEQ           (V4L2_CID_PRIVACY + 106)
#define V4L2_CID_SET_MAX_EXPO_TIME      (V4L2_CID_PRIVACY + 107)
...
#define V4L2_CID_HWSCOPE				(V4L2_CID_PRIVACY + 110)
/* zhoutian 00195335 2012-10-20 added for hwscope end > */

/* < zhoutian 00195335 2013-03-02 added for SuperZoom-LowLight begin */
#define V4L2_CID_HW_LOWLIGHT				(V4L2_CID_PRIVACY + 112)
#define V4L2_CID_GET_HW_LOWLIGHT_SUPPORTED	(V4L2_CID_PRIVACY + 113)
#define V4L2_CID_GET_BINNING_SIZE			(V4L2_CID_PRIVACY + 114)
...
#define V4L2_CID_GET_HDR_ISO_EXP_VALUE           (V4L2_CID_PRIVACY + 206)


#define V4L2_CID_SET_HDR_MOVIE_MODE                			(V4L2_CID_PRIVACY + 122)
#define V4L2_CID_GET_HDR_MOVIE_CONSTANT_PARAM      (V4L2_CID_PRIVACY + 123)
#define V4L2_CID_GET_HDR_MOVIE_VOLATILE_PARAM      (V4L2_CID_PRIVACY + 124)
#define V4L2_CID_SET_HDR_MOVIE_AE_RESULT          	 (V4L2_CID_PRIVACY + 125)

#define V4L2_CID_GET_SENSOR_MAX_PREVIEW_SIZE       (V4L2_CID_PRIVACY + 126)

#define V4L2_CID_GET_HDR_MOVIE_SUPPORTED       (V4L2_CID_PRIVACY + 127)

#define V4L2_CID_GET_LCD_COMPENSATION_SUPPORTED	(V4L2_CID_PRIVACY + 128)
#define V4L2_CID_GET_LCD_COMPENSATION_NEEDED	(V4L2_CID_PRIVACY + 129)
