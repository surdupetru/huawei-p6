...
{
	return k3_ispio_read_reg(ov8830_sensor.i2c_config.index,
				 ov8830_sensor.i2c_config.addr, reg, (u16*)val, ov8830_sensor.i2c_config.val_bits);
}
...
{
	return k3_ispio_write_reg(ov8830_sensor.i2c_config.index,
			ov8830_sensor.i2c_config.addr, reg, val, ov8830_sensor.i2c_config.val_bits, mask);
}
...
static int ov8830_write_seq(const struct _sensor_reg_t *seq, u32 size, u8 mask)
{
	...
	return k3_ispio_write_seq(ov8830_sensor.i2c_config.index,
			ov8830_sensor.i2c_config.addr, seq, size, ov8830_sensor.i2c_config.val_bits, mask);
}
...
static void ov8830_set_default(void)
{
	...
	ov8830_sensor.i2c_config.addr_bits = 16;
