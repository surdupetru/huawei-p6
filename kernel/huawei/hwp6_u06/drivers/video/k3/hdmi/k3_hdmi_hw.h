...
#define HDMI_CORE_DDC_FIFOCNT              0x3D4ul
#define HDMI_CORE_DDC_SEGM                 0x3B8ul
#define HDMI_CORE_SYS_SHA_CONTROL          0x330ul  /* SHA Control */
...
#define HDMI_CORE_SYS_EPCM                 0x3E8ul  /* bit5 load ksv */
...
typedef struct _hdmi_hw_res {
    ...
    struct block_config *iomux_block_config;
