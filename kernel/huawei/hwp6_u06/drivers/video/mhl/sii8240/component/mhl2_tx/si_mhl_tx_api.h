...
#define	MHL_TX_EVENT_UCP_RECEIVED		    0x0E	/* Received an UCP. Key Code in "eventParameter" */
#define	MHL_TX_EVENT_UCPK_RECEIVED		    0x0F	/* Received an UCPK message */
#define	MHL_TX_EVENT_UCPE_RECEIVED		    0x10	/* Received an UCPE message .*/
...
// SiiMhlTxUcpSend
//
// This function checks if the peer device supports RCP and sends ucpKeyCode. The
// function will return a value of true if it could successfully send the RCP
// subcommand and the key code. Otherwise false.
//
...
/*
    Application must provide this function
*/
