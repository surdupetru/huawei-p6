        ...
        BIT_TPI_HDCP_CONTROL_DATA_COPP_PROTLEVEL_MASK    = 0x01
                        ,BIT_TPI_HDCP_CONTROL_DATA_COPP_PROTLEVEL_MIN     = 0x00
                                        ,BIT_TPI_HDCP_CONTROL_DATA_COPP_PROTLEVEL_MAX     = 0x01
                                                        ...
                                                        ,BIT_TPI_HDCP_CONTROL_DATA_DDC_SHORT_RI_RD_MASK   = 0x02
                                                                        ,BIT_TPI_HDCP_CONTROL_DATA_DDC_SHORT_RI_RD_DISABLE= 0x00
                                                                                        ,BIT_TPI_HDCP_CONTROL_DATA_DDC_SHORT_RI_RD_ENABLE = 0x02
...
#define REG_TPI_V_PRIME_SELECTOR			(TX_PAGE_TPI | 0x0031)
typedef enum
{
        BIT_TPI_V_PRIME_SELECTOR_AUTH_STATE_MASK              = 0xC0
                        , BIT_TPI_V_PRIME_SELECTOR_AUTH_STATE_AUTH_REQD         = 0x00
                                        , BIT_TPI_V_PRIME_SELECTOR_AUTH_STATE_RE_AUTH_REQD      = 0x40
                                                        , BIT_TPI_V_PRIME_SELECTOR_AUTH_STATE_AUTHENTICATED     = 0x80
                                                                        , BIT_TPI_V_PRIME_SELECTOR_AUTH_STATE_RPTR_AUTH_REQD    = 0xC0
} BitsVPrimeSelector_e;
